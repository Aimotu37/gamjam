...
[CreateAssetMenu(fileName = "PlayClip1", menuName = "Actions/Play Clip1")]
public class PlayClipAction1 : StateAction
{
    [Header("遮罩设置")]
    ...
    public override IEnumerator Execute()
    {
        ...
        videoPlayer.audioOutputMode = VideoAudioOutputMode.Direct; // 可选：音频设置
