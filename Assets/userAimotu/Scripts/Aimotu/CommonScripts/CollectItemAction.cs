...
{
    public enum CollectType { PasswordClue, Diary, InteractableItems }
    ...
    public override IEnumerator Execute()
    {
        ...
        var taskS5 = Object.FindAnyObjectByType<S5.Task_S5>();
        ...
        else if (collectType == CollectType.InteractableItems)
        {
            taskS5?.InteractedItem(itemType);
            Debug.Log($"[InteractedItemAction] 密码线索：{itemType}");
        }
